...
const template = (name: string, description: string, installDescription: string, disableDescription: boolean, disableScreenshots: boolean, disableClose: boolean, icon: string, manifest: WebAppManifest, installAvailable: any, hideDialog: any, howToForApple: any, isDesktop: boolean, howToRequested: boolean, toggleGallery: any, galleryRequested: boolean,isSafariBrowser:boolean, isRTL: boolean = false) => {
                ...
                <div class="how-to-body">
                    <div class="how-to-description">
                        ...
                        <div class="description-step">
                            ...
                            <div class="step-text">${msg('1) Open website in Safari')}</div>
                        </div>`: ''}
                        <div class="description-step">
                            <div class="svg-wrap">
